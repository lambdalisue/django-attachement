...
setup(
    ...
    url=r"https://github.com/lambdalisue/django-attachment",
    download_url = r"https://github.com/lambdalisue/django-attachment/tarball/master",
    license = 'MIT',
    zip_safe=False,
